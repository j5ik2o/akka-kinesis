...
object Dependencies {
  ...
  object amazonAws {
    ...
    val kinesisProducer      = "com.amazonaws" % "amazon-kinesis-producer"          % "0.14.7"
    val kinesisClient        = "com.amazonaws" % "amazon-kinesis-client"            % "1.14.3"
