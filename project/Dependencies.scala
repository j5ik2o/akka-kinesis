...
object Dependencies {
  ...
  object amazonAws {
    ...
    val kinesisClientV1      = "com.amazonaws"           % "amazon-kinesis-client"            % "1.14.3"
    val kinesisClientV2      = "software.amazon.kinesis" % "amazon-kinesis-client"            % "2.3.4"
    val streamKinesisAdaptor = "com.amazonaws"           % "dynamodb-streams-kinesis-adapter" % "1.5.3"
  }
